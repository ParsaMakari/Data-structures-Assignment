...
Les invariants structurels d'un arbre de préfixes sont: Une racine unique, un chemin représente un préfixe, les noeuds qui complète un mot sont marqué comme tel. Chaque mot est représenté par un seul chemin. Les opérations n'affectent pas les invariants. La recherche ne modifie rien de l'arbre.
